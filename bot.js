...
client.on('message', message => {
    if(message.content.includes('discord.gg')){
        ...
        message.delete()
    return message.reply(`** No Invite Links you is warn 😠 !**`)
    }
}
});
...
if (message.content.startsWith('هلا')){
  ...
  .setColor("RANADOM")
  .setDescription(" **هلا بيك حبي منور **")
...
if (message.content.startsWith('السلام عليكم')){
  ...
  .setAuthor(message.author.username)
  .setColor("RANADOM")
  .setDescription(" **السَّلامُ عَلَيْكُم ورَحْمَةُ اللهِ وَبَرَكاتُهُ**")
...
if (message.content.startsWith('مرحبا')){
  ...
  .setAuthor(message.author.username)
  .setColor("RANADOM")
  .setDescription(" **مرحبا بك انت حبي :two_hearts: **")
...
client.on('message', message => {
if (message.content.startsWith('هدف البوت')){
     let ra3d = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("RANADOM")
  .setDescription(" **التطور بي وهبه من الله انشا الله **")
...
client.on('message', message=> {
    ...
    {
    message.reply(" هلا حبي اتمني ان اكون عجبتك:heart:  ");
    }
});
...
client.on("message", message => {    
   ...
   if(message.author.bot) return;
      ...
      .setTitle(`:snowflake: هدف البوت هو اسعادكم ** ${message.guild.name} **`)
...
message.author.sendEmbed(embed)
                    ...
                    client.on('message', message => {
                                if(!message.channel.guild) return;
                        if (message.content.startsWith('*ping-bot')) {
                            if(!message.channel.guild) return;
                            var msg = `${Date.now() - message.createdTimestamp}`
                            var api = `${Math.round(client.ping)}`
                            if (message.author.bot) return;
  ...
  client.on('message', (message) => {
    if (message.content.startsWith('*kick')) {
        var member= message.mentions.members.first();
        member.kick().then((member) => {
            message.channel.send(member.displayName + ' • banned from the server ! :airplane: ');
        }).catch(() => {
...
client.on('message', (message) => {
    if (message.content.startsWith('*ban ')) {
      if(!message.member.hasPermission('BAN_MEMBERS')) return message.reply('ه\هالخصيه للاداره فقط');
        var member= message.mentions.members.first();
...
client.on('message', message => {
    ...
    if(message.content.includes('discord.gg')){
      if(!message.member.hasPermission('ADMINISTRATOR'))
        message.delete()
    return message.reply(`** NOTE ALWDED HERE ! **`)
    }
});
...
if (message.content === '*programer-of-bot') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** :trident: THE KILER :heart:   **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('guildMemberAdd', member => {
    ...
    client.on('guildMemberRemove', member => {
        ...
        .setTitle(`باي سنفتقدك:raised_hand::skin-tone-1: :pensive:`)
...
client.on("message", message => {
            if(message.content.startsWith("*applay")) {
        if(!message.channel.guild) return;
                if(message.author.bot) return;
...
client.on('message', msg => {
  if(msg.content === '*hide') {
    ...
    msg.channel.send('تم قفل الرومات برجا الانتظار لين  ميخلص')
  }
})
 ...
 client.on('message', msg => {
  if(msg.content === '*unhide') {
    ...
    msg.channel.send('تم اظهار الرومات و شكرا لانتظركم')
  }
})
...
client.on('message', msg => {
 ...
 client.on('message', message => {
          let args = message.content.split(' ').slice(1);
   if(message.content.split(' ')[0] == '*colore'){
